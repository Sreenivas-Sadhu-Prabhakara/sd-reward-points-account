package com.bank.bian.rewardpointsaccount.model;
...
/**
 * The BIAN control record for this service domain: "Reward Points Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Reward Points Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Reward Points Facility Fulfillment Arrangement";
